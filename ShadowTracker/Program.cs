...
namespace ShadowTracker
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Write(e);
                Game.PrintChat("ShadowTracker is not working. plz send message by KorFresh (Code 2)");
            }
        }
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            {
                Console.Write(e);
                Game.PrintChat("ShadowTracker is not working. plz send message by KorFresh (Code 3)");
            }
        }
        ...
        private static void OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.Write(e);
                Game.PrintChat("ShadowTracker is not working. plz send message by KorFresh (Code 4)");
            }
        }
        ...
        private static void AntiGapcloser_OnEnemyGapcloser(ActiveGapcloser gapcloser)
        {
            ...
            {
                Console.Write(e);
                Game.PrintChat("ShadowTracker is not working. plz send message by KorFresh (Code 6)");
            }
        }
        ...
        private static void OnProcessSpell(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            {
                Console.Write(e);
                Game.PrintChat("ShadowTracker is not working. plz send message by KorFresh (Code 7)");
            }
        }
