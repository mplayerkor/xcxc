    ...
    class Ryze
    {
        ...
        public static void Drawing_OnDraw(EventArgs args)
        {
            try
            {
                ...
                {
                    if (RyzePassive.EndTime - Game.ClockTime > 2f)
                        Drawing.DrawText(PlayerPosition2.X - 20, PlayerPosition2.Y + 30, Color.Gold, "Stack Time: " + "{0:#.##}", RyzePassive.EndTime - Game.ClockTime);
                    else
                        Drawing.DrawText(PlayerPosition2.X - 20, PlayerPosition2.Y + 30, Color.Red, "Stack Time: " + "{0:#.##}", RyzePassive.EndTime - Game.ClockTime);
                }
